...
# import ... as
@test_throws ParseError("\"as\" can only be used with \"import\", not \"using\"") Meta.parse("using A as B")
@test_throws ParseError("\"as\" can only be used with \"import\", not \"using\"") Meta.parse("using A.b as B")
@test_throws ParseError("\"as\" can only be used with \"import\", not \"using\"") Meta.parse("using A.b: x as y")
